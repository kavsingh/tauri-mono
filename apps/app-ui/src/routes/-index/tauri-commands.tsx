...
import { openExternalUrlMutation, openUserDirMutation } from "~/services/tauri";

import type { ParentProps } from "solid-js";
import type { ButtonProps } from "~/components/button";

const logger = createScopedLogger("<TauriCommands />");
...
export function TauriCommands() {
	...
	return (
		<div class="space-y-1.5">
			...
			<div class="flex flex-wrap items-center gap-1.5">
				<ExternalUrlButton variant="destructive" url="https://www.google.com">
					Open blocked url
				</ExternalUrlButton>
